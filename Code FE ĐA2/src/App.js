...
import RentalPosts from "./page/user/RentalPosts";
    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/rentalposts" element={<RentalPosts authenticated={authenticated} currentUser={currentUser} onLogout={handleLogout} />} />
