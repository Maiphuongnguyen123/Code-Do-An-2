...
function RoomManagement(props) {
    ...
    const mockRooms = [
    { id: 1, title: "Phòng trọ số 1", price: 3000000, status: "pending", ownerId: 101 },
    { id: 2, title: "Phòng trọ số 2", price: 4000000, status: "approved", ownerId: 102 },
    { id: 3, title: "Phòng trọ số 3", price: 5000000, status: "pending", ownerId: 103 },
    { id: 4, title: "Phòng trọ số 4", price: 6000000, status: "approved", ownerId: 104 },
    { id: 5, title: "Phòng trọ số 5", price: 7000000, status: "pending", ownerId: 105 },
];

const mockUsers = [
    { id: 101, email: "owner1@example.com", name: "Nguyễn Văn A" },
    { id: 102, email: "owner2@example.com", name: "Trần Thị B" },
    { id: 103, email: "owner3@example.com", name: "Phạm Văn C" },
    { id: 104, email: "owner4@example.com", name: "Lê Thị D" },
    { id: 105, email: "owner5@example.com", name: "Ngô Văn E" },
];
// Gán dữ liệu mock vào trạng thái khi trang được tải
useEffect(() => {
                            ...
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                ...
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter">
                                    ...
                                    <tbody>
                                        ...
                                        {tableData.map((room) => {
                                                    const owner = mockUsers.find((user) => user.id === room.ownerId);
                                                    return (
                                                        <tr key={room.id}>
                                                            <td>{room.title}</td>
                                                            <td>
                                                            ...
                                                            <td>{room.status === "approved" ? "Đã duyệt" : "Chờ duyệt"}</td>
                                                            <td>{owner ? owner.name : "N/A"}</td>
                                                            <td>
                                                                <button className="btn btn-success" onClick={() => handleSetRoomId(room.id)}>
                                                                    Chi tiết
                                                                </button>
                                                            </td>
                                                        </tr>
