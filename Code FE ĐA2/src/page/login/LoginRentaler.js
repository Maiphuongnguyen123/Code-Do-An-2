                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-8">
                                    <div className="mb-4">
                                        ...
                                        <p className="mb-4">Bạn đang đăng nhập với vai trò </p> <p classname ="mb-4" style={{ fontWeight: 'bold' }}> NGƯỜI CHO THUÊ TRỌ</p> <p className="mb-4">Nếu bạn chưa có tài khoản hãy <a href="/signup-rentaler">Đăng ký tài khoản mới</a></p>
                                    </div>
                                    <LoginForm />
                                </div>
                            </div>
