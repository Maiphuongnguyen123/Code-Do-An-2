                                ...
                                <div class="widget-a">
                                    ...
                                    <div class="w-footer-a">
                                        <ul class="list-unstyled">
                                            <li class="color-a">
                                                <span class="color-text-a">Email: </span> cskh@renmate.com
                                            </li>
                                            <li class="color-a">
                                                <span class="color-text-a">Số điện thoại: </span> +84365 744 905
                                            </li>
                                            <li class="color-a">
                                                <span class="color-text-a">Địa chỉ: </span> Số 1 Đại Cồ Việt, Hai Bà Trưng, Hà Nội
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="w-body-a">
                                        <div class="w-body-a">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="item-list-a">
                                                    <i class="bi bi-chevron-right"></i> <a href="#">Hướng dẫn sử dụng RentMate</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
